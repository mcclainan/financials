<%@page sitemeshPreprocess="false"%><!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
  ...
  <section id="container" class="">
      ...
      <!--logo start-->
          <g:link uri="/" class="logo">Nice <span class="lite">Admin</span></g:link>
      <!--logo end-->
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><g:link class="" href="/blank">Blank Page</g:link></li>
                          <li><g:link class="" href="/404">404 Error</g:link></li>
                      </ul>
                  </li>
